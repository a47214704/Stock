...
**MACD 用紅漲綠跌，但紅綠對色盲不友善。** 實測紅綠在紅綠色盲下的
色差只有 ΔE 4.1（安全門檻是 8），是配色的經典地雷。這裡仍採台股慣例，
理由是柱狀體的正負是靠**零軸上下的位置**表達的，顏色只是附帶慣例，
換掉顏色不會讓任何資訊消失。另外提供「色盲友善」開關把綠柱換成藍色
（ΔE 23.8，通過所有檢查），開關會連帶更新說明文字與表格欄名。
